...
class Consola:
    ...
    def __ui_clienti_dupa_nume(self,valoare):
        ...
        lista = self.__serviceInchirieri.sortare_cresc_alfabet(lista,self.__serviceInchirieri.key_word)
    ...
    def __ui_statistica_genuri(self,valoare):
        ...
        lista = self.__serviceInchirieri.sortare_cresc_numar(lista,self.__serviceInchirieri.cmp_number)
        for sub_lista in lista:
